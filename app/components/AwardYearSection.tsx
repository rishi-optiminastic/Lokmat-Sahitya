    ...
    <>
      ...
      {activeAwardee && (
        ...
        >
          ...
          />
          <div className="relative z-[111] w-full max-w-xl overflow-y-auto rounded-2xl bg-white shadow-[var(--shadow-lg)] md:max-h-[85vh]">
            <div className="sticky top-0 z-10 flex items-start justify-between gap-4 rounded-t-2xl bg-white px-6 pb-4 pt-6 md:px-8 md:pt-8">
              <div>
                ...
                {activeAwardee.category && (
                  <span className="mt-2 inline-block rounded-full bg-sky-50 px-3 py-0.5 text-xs font-semibold text-sky-700 ring-1 ring-sky-200">
                    {activeAwardee.category}
                  </span>
                )}
              </div>
